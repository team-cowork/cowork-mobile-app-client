...
class NotesStore {
  ...
  static const _seed = [
    Note(
      ...
      tags: ['확정', 'OKR'],
      summary:
          '분기 목표 정렬 및 팀별 OKR 확정. 채팅·이슈 트래커 MVP 범위 합의, 음성 채널은 입장/대화만 포함하기로 결정.',
      ...
      participants: ['도', '서', '민'],
      agenda: ['1. 1분기 팀 목표 및 OKR 정렬', '2. 채팅·이슈 트래커 MVP 범위', '3. 음성 채널 포함 여부'],
      decisions: [
    ...
    Note(
      ...
      author: NoteAuthor(authorId: 2, name: '도윤', initial: '도', date: '03.08'),
    ),
    Note(
      id: 2,
      title: '음성 채널 기술 검토',
      tags: ['확정', '기술'],
      summary:
          'WebRTC 직접 구현 vs 외부 SDK 비교. 동시 접속 인원 제한 정책 논의 — 채널 설정에서 선택 적용하기로.',
      author: NoteAuthor(authorId: 3, name: '서연', initial: '서', date: '03.05'),
    ),
    Note(
      id: 3,
      title: '스프린트 회고 #3',
      ...
      author: NoteAuthor(authorId: 4, name: '민재', initial: '민', date: '02.28'),
    ),
  ];
}
