      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text('채팅/파일/계정 공유 같은 탭성 전환에 사용합니다.', style: AppFont.subtextL),
            ...
            SizedBox(
              ...
              child: CoworkSegmentedControl<String>(
                ...
                onChanged: (next) => setState(() => _threeSegmentValueM = next),
              ),
            ),
            const SizedBox(height: 16),
            SizedBox(
              ...
              child: CoworkSegmentedControl<String>(
                ...
                size: CoworkSegmentedControlSize.large,
                onChanged: (next) => setState(() => _threeSegmentValueL = next),
              ),
            ),
            const SizedBox(height: 16),
            SizedBox(
